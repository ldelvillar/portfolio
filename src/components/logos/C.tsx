...
export default function CLogo(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            viewBox="0 0 306 345"
        ...
        >
            ...
            <path
                fill="#004482"
                d="M166.25 341.193l126.5-73.034c3.644-2.104 6.956-5.737 9.357-9.897L153 172.175 3.893 258.263c2.4 4.159 5.714 7.793 9.357 9.896l126.5 73.034c7.287 4.208 19.213 4.208 26.5 0z"
            />
            <path
                fill="#659AD2"
